...
quotes = ['Luch is what happens when preparation meets opportunity',
          'All crutely springs from weekness',
          'Begin at once to live, and count each separate day as a separate life',
          'Throw me to the wolves and will return leading the pack']
